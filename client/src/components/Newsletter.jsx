...
export default function Newsletter() {
  return (
    <div className="flex flex-col items-center justify-center text-center py-16 px-5 md:px-8">
      ...
      <form className="flex items-center justify-center max-w-2xl h-12 md:h-14 bg-white rounded-md ">
        <input type="email" placeholder="Enter your email" required className="border border-gray-300 rounded-md h-full border-r-0 outline-none rounded-r-none px-14"/>
