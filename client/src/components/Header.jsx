    ...
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
        ...
        <div className='inline-flex items-center justify-center gap-4 px-6 py-1.5 mb-4 border border-primary/40 bg-primary/10 rounded-full text-sm text-primary' >
            <p>New: AI feature integrated <i className="fa-solid fa-bolt"></i>
            </p>
        </div>

        <h1 className='text-3xl sm:text-6xl font-semibold sm:leading-16 text-gray-700 header-name'>Your own <span className='text-primary'>blogging</span>  <br/> platform.</h1>
      ...
      <div className='text-center'>
        {input && 
          <button onClick={onClear} className='border font-light text-xs text-primary/60 py-1 px-3 rounded-sm shadow-custom cursor-pointer border-primary/40 bg-primary/8'>Clear Search</button>
        }
      </div>
